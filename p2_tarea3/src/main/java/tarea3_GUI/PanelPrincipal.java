...
public class PanelPrincipal extends JPanel {
    ...
    public PanelPrincipal(Color color){
        ...
        this.panel_expendedor = new PanelExpendedor(Color.green, comprador, expendedor, panel_comprador);
        this.panel_comprador = new PanelComprador(Color.white, comprador, expendedor, panel_expendedor);
